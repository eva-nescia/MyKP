...
class KPProgressSeeder extends Seeder
{
    ...
    {
        $template = [
            ['kp_category' => 'O-Week',                         'kp_current_amount' => 0,  'kp_amount_requirement' => 6],
            ['kp_category' => 'Upacara',                        'kp_current_amount' => 0,  'kp_amount_requirement' => 4],
            ['kp_category' => 'Camp Mahasiswa (CampJur)',       'kp_current_amount' => 0,  'kp_amount_requirement' => 4],
            ['kp_category' => 'Pra Latihan Dasar Kepemimpinan', 'kp_current_amount' => 0,  'kp_amount_requirement' => 4],
            ['kp_category' => 'Organisasi Kemahasiswaan',       'kp_current_amount' => 0, 'kp_amount_requirement' => 20],
            ['kp_category' => 'Mentoring',                      'kp_current_amount' => 0,  'kp_amount_requirement' => 15],
            ['kp_category' => 'Talkshow Wajib BMA',             'kp_current_amount' => 0,  'kp_amount_requirement' => 6],
            ...
            ['kp_category' => 'Lain-lain',                      'kp_current_amount' => 0,  'kp_amount_requirement' => 15],
        ];
