...
EOT,
        ...
        $this->seedListItems($seminarBelaNegara->ActivityID, [
            ...
            'contact_persons' => ['Student Council UC Makassar - studentcouncil.makassar@ciputra.ac.id'],
        ]);
        ...
        $doaLintasIman = Activity::factory()->create([
            ...
            'kp_category' => 'Talkshow Wajib BMA',
            'kp_amount' => 4,
            'eligible_generation' => 'Gen 5 (Wajib), All Gen',
            'eligible_study_program' => 'All Prodi',
...
EOT,
        ...
        $this->seedListItems($doaLintasIman->ActivityID, [
            ...
            'claiming_procedures' => ['Auto input by BMA after attendance is recorded'],
            'contact_persons' => ['Instagram @Fdu.ucm', 'BMA UC Makassar'],
        ]);
...
EOT,
        ...
        $this->seedListItems($empowerCare->ActivityID, [
            ...
            'contact_persons' => ['+62 856-9603-0800 (Andrew)'],
        ]);
        ...
        $oprecSC = Activity::factory()->create([
            ...
            'kp_amount' => 20,
            'eligible_generation' => 'Gen 2023 (Presiden), Gen 2023/2024 (Wakil)',
            'eligible_study_program' => 'All Prodi',
...
EOT,
        ...
        $this->seedListItems($oprecSC->ActivityID, [
            ...
            'contact_persons' => [
                ...
                'studentcouncil.makassar@ciputra.ac.id',
            ],
        ]);
        ...
        $panitiaExpoEII = Activity::factory()->create([
            ...
            'kp_amount' => 5,
            'eligible_generation' => 'Angkatan 2024/2025',
            'eligible_study_program' => 'All Prodi',
            'date' => now()->addDays(14)->toDateString(),
            'start_time' => '09:00:00',
            'end_time' => '17:00:00',
...
EOT,
        ...
        $this->seedListItems($panitiaExpoEII->ActivityID, [
            ...
            'contact_persons' => ['+62 899-0326-888 (Carol)'],
        ]);
        ...
        $flamiansCup = Activity::factory()->create([
            ...
            'kp_category' => 'Kepanitiaan',
            'kp_amount' => 8,
            'eligible_generation' => 'Angkatan 2023-2025',
            'eligible_study_program' => 'All Prodi',
...
EOT,
        ...
        $oWeek = Activity::factory()->create([
            ...
            'kp_category' => 'Kepanitiaan',
            'kp_amount' => 10,
            'eligible_generation' => 'Angkatan 2023-2024',
            'eligible_study_program' => 'All Prodi',
...
EOT,
        ...
        $this->seedListItems($oWeek->ActivityID, [
            ...
            'contact_persons' => ['+62 813-1090-6378 (Diana)'],
        ]);
...
EOT,
        ...
        $brandExpo = Activity::factory()->create([
            ...
            'kp_category' => 'Kepanitiaan',
            'kp_amount' => 8,
            'eligible_generation' => 'Angkatan 2024',
            'eligible_study_program' => 'All Prodi',
...
EOT,
        ...
        $this->seedListItems($brandExpo->ActivityID, [
            ...
            'contact_persons' => ['+62 821-9520-8675 (Allan)'],
        ]);
...
EOT,
        ...
        $this->seedListItems($expoEI->ActivityID, [
            ...
            'contact_persons' => ['+62 823-3555-5516 (Howeld)'],
        ]);
    }
