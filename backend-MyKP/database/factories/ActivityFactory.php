...
class ActivityFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'kp_category' => fake()->randomElement(['Kepanitiaan', 'Talkshow Wajib BMA', 'Organisasi Kemahasiswaan']),
            'kp_amount' => fake()->numberBetween(5, 20),
            'eligible_generation' => fake()->year(),
            'eligible_study_program' => fake()->randomElement(['IMT', 'MAN', 'VCD']),
            'date' => fake()->date(),
            'time' => fake()->time('H:i'),
